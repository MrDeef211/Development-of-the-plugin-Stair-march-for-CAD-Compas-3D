...
namespace Tests
{
	...
	public class ParametersUnitTests
	{
		...
		[Test]
		[Description("ѕроверка инициализации параметра вне допустимого диапазона")]
		...
		[Description("ѕроверка передачи параметра")]
		...
		[Test]
		[Description("ѕроверка передачи параметра вне диапазона")]
		...
		[Test]
		[Description("ѕроверка передачи неправильного выступа ступени")]
		...
		[Test]
		[Description("ѕроверка передачи нецелочисленного количества ступеней")]
		...
		[Test]
		[Description("ѕроверка пересчета высоты ступени при изменении высоты")]
		...
		[Test]
		[Description("ѕроверка пересчета высоты марша при изменении высоты ступени")]
