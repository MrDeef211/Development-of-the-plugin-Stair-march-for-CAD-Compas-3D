...
namespace Tests
{
	...
	public class ParametersUnitTests
	{
		...
		[Test]
		[Description("ѕроверка инициализации параметра " +
		...
		[Test]
		[Description("ѕроверка пересчета высоты ступени " +
		...
		[Test]
		[Description("ѕроверка пересчета высоты марша " +
